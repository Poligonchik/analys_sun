...
def basic_analysis_srs():
    ...
    # Загрузка данных из Parquet (у вас их нет в репозитории)
...
def visualize_srs_data():
    ...
    # Гистограмма распределения числа пятен
    plt.figure(figsize=(8, 5))
    ...
    # Pairplot для числовых столбцов
    sunspots_df["Lo"] = pd.to_numeric(sunspots_df["Lo"], errors="coerce") # Приведём Lo к числовому типу
    ...
    # График зависимости широты от площади
    plt.figure(figsize=(8, 5))
    ...
    # График зависимости широты от числа пятен
    plt.figure(figsize=(8, 5))
    ...
    # Сравнение распределения площади по магнитным типам
    plt.figure(figsize=(8, 5))
