...
print_metrics(y_test, pred_lgb, prob_lgb, "LightGBM (24h)")

rf_model = RandomForestClassifier(n_estimators=100, random_state=42, class_weight='balanced', n_jobs=-1)
rf_model.fit(X_train, y_train)
prob_rf = rf_model.predict_proba(X_test)[:, 1]
pred_rf = rf_model.predict(X_test)
print_metrics(y_test, pred_rf, prob_rf, "RandomForest (24h)")
...
print_metrics(y_test, pred_xgb, prob_xgb, "XGBoost (24h)")
...
#############################################
joblib.dump(lgb_model, "../models/s_e_lgb_model_merged_24.pkl")
joblib.dump(rf_model, "../models/s_e_rf_model_merged_24.pkl")
joblib.dump(xgb_model, "../models/s_e_xgb_model_merged_24.pkl")
...
print_metrics(y_test, pred_stack, prob_stack, "Stacking Ensemble (24h)")

# Сохраняем стэкинг-модель
joblib.dump(meta_model, "../models/s_e_stacking_model_merged_24.pkl")
print("Стэкинговая модель сохранена в 's_e_stacking_model_merged_24.pkl'.")