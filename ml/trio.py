...
# Выбираем интересующие признаки из DSD: radio_flux, sunspot_number, hemispheric_area, new_regions, background, flares.C, flares.M, flares.X, flares.S
new_features = ['radio_flux', 'sunspot_number', 'hemispheric_area', 'new_regions', 'background',
                'flares.C', 'flares.M', 'flares.X', 'flares.S']
# Пример строки из DSD:
# {
#    "date": "2015 10 06",
#    "radio_flux": 81.0,
#    "sunspot_number": 24,
#    "hemispheric_area": 110.0,
#    "new_regions": 1,
#    "x_ray_flux": "B1.0",
#    "background": 0.0,
#    "flares.C": 0.0,
