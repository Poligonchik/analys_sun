...
# Создаем таргеты для горизонтов 12, 24, 48 и теперь 72 часа:
...
# Удаляем строки с пропусками среди признаков и таргета target_72
df_clean = df.dropna(subset=features + ['target_72']).reset_index(drop=True)
...
#############################################
# Обучение моделей для бинарной классификации (target_72)
#############################################
...
#############################################
# Вывод метрик для моделей (предсказание вспышки в течение 72 часов)
#############################################
...
stack_model_filename = "../models/stacking_model_target_72.pkl"
...
print(f"\nМодель LightGBM (72 часов, бинарная) сохранена в {lgb_model_filename}")
print(f"Модель Random Forest (72 часов, бинарная) сохранена в {rf_model_filename}")
print(f"Модель XGBoost (72 часов, бинарная) сохранена в {xgb_model_filename}")
print(f"Модель Stacking (72 часов, бинарная) сохранена в {stack_model_filename}")
